...
1. **Sorgfältige Auswahl** (§ 203 Abs. 4 StGB) — Sie müssen den Anbieter begründet auswählen können, etwa anhand dokumentierter technischer und organisatorischer Maßnahmen und einer nachvollziehbaren Subprozessorenliste.
2. **Wirksame Verschwiegenheitsverpflichtung** — eine reine AGB-Zustimmung eines Chatbot-Anbieters erfüllt diese Anforderung in aller Regel nicht. Notwendig ist eine dedizierte vertragliche Verpflichtung, die konkret auf § 203 StGB zugeschnitten ist.
...
Wer einen strukturierten Überblick über Angebote sucht, findet auf [/unterlagen](/unterlagen) die passenden Mustervorlagen — AVV, TOM und § 203-Zusatzvereinbarung — als Ausgangspunkt für die eigene Prüfung, und auf [/eu-ki-recht](/eu-ki-recht) die vollständige regulatorische Einordnung über die Arztpraxis hinaus.
...
Wer die grundsätzliche Funktionsweise eines konformen KI-Gateways vorab ohne Risiko nachvollziehen möchte, kann das im [Playground](/playground) mit aufgezeichneten Beispielantworten tun; die Tarifstruktur dahinter findet sich unter [/preise](/preise). Weiterführend zur AVV-Prüfung bei beliebigen Anbietern: [AVV mit KI-Anbietern](/ratgeber/avv-ki-anbieter); zu datenschutzkonformen Alternativen allgemein: [DSGVO-konforme KI-Alternativen](/ratgeber/dsgvo-konforme-ki-alternativen); zur vergleichbaren Problematik in Kanzleien: [ChatGPT in der Kanzlei](/ratgeber/chatgpt-kanzlei-datenschutz).
