...
Sofern nicht anders angegeben, gelten die in diesem Abschnitt aufgeführten Nutzungsbedingungen allgemein für die Nutzung dieser Anwendung und des Dienstes.
...
Sofern nicht anders angegeben oder eindeutig erkennbar, sind alle in dieser Anwendung verfügbaren Inhalte Eigentum des Eigentümers oder seiner Lizenzgeber.

### RECHTE AN DEN INHALTEN DIESER ANWENDUNG — ALLE RECHTE VORBEHALTEN

Der Eigentümer hält und behält sich alle geistigen Eigentumsrechte für diese Inhalte vor. Nutzer dürfen diese Inhalte nicht in einer Weise nutzen, die nicht für die ordnungsgemäße Nutzung des Dienstes erforderlich oder implizit ist.
...
Informationen zur Verwendung personenbezogener Daten finden die Nutzer in der [Datenschutzerklärung](/datenschutz) dieser Anwendung.

## KEINE RECHTSBERATUNG

Die erbrachten Leistungen stellen keine Rechtsberatung dar und ersetzen keine anwaltliche Prüfung im Einzelfall. Siehe [RDG-Hinweis](/rdg-hinweis).

## ÄNDERUNGEN DIESER BEDINGUNGEN

Der Eigentümer behält sich das Recht vor, diese Bedingungen jederzeit zu ändern oder anderweitig zu aktualisieren. In solchen Fällen wird der Eigentümer den Nutzer angemessen über diese Änderungen informieren.

## KONTAKT

Alle Mitteilungen im Zusammenhang mit der Nutzung dieser Anwendung müssen über die in diesem Dokument angegebenen Kontaktinformationen gesendet werden.

## SALVATORISCHE KLAUSEL

Sollte eine Bestimmung dieser Bedingungen nach geltendem Recht als ungültig oder nicht durchsetzbar erachtet werden, berührt dies nicht die Gültigkeit der übrigen Bestimmungen.

## ANWENDBARES RECHT

Diese Bedingungen unterliegen deutschem Recht, ohne Berücksichtigung von Kollisionsnormen.
