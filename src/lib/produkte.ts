...
export const PRODUKTE: Produkt[] = [
  {
    ...
    einzeiler: 'Ein Sprachmodell auf unseren Servern in Nürnberg — kein Logging, kein Training, deutsche GmbH, §203-Zusatzvereinbarung.',
    zielgruppe: 'Kanzleien, Steuerberatung, Praxen und Notariate — Berufsgeheimnisträger nach § 203 StGB',
    punkte: ['Verschwiegenheitsvereinbarung nach § 203 StGB', 'Kein Logging, kein Training auf Ihren Daten', 'Deutsche GmbH, keine US-Muttergesellschaft'],
    beschreibung:
      'Gehostete Inferenz auf Servern der DataFortress.cloud GmbH im Hetzner-Rechenzentrum Nürnberg. Kein fremder Modellanbieter, kein Transfer ins Ausland — der einzige unserer drei Wege, für den wir eine §203-Zusatzvereinbarung unterschreiben, weil nur hier niemand beteiligt ist, den wir nicht selbst verpflichten können.',
    stufen: ['de-only'],
